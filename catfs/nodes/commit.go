...
func (c *Commit) setCommitAttrs(seg *capnp.Segment) (*capnp_model.Commit, error) {
	...
	if err := capCmt.SetMsg(c.message); err != nil {
		return nil, err
	}
...
// padHash will take a Hash and pad its representation to 2048 bytes.
...
// IsBoxed will return True if the commit was already boxed
