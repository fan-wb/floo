...
// NewWriterWithTypeAndBlockSize returns a new Writer which encrypts data with a certain key.
// If `compressionFlag` is true, the compression flag in the file header will also be true.
